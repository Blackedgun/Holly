...
<head>
  ...
  <link rel="stylesheet" href="../css/Tiendacss/Storechaqueta.css" />
...
<body style="background: url(../img/pinkdot2.jpg)">
  <header class="header">
    ...
    <i style="transform: translate(-40px); color: beige;" class="fas fa-shopping-cart fa-2x"></i>
  ...
  <div class="slider-frame">
    ...
    <div>
      <p class="texta">Chaquetas Holly Dashing</p>
    </div>
  </div>
  <section>
  ...
  <div class="main-container">
    ...
    <div class="container-pop-items">
      ...
      <?php
      $inv = "SELECT * FROM producto WHERE cat_id = 5";
